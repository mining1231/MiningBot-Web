const farmingData = {
    1: {
        ...
        exp: "100",
        drops: [
            { icon: "🍑", name: "복숭아 ×1", chance: "70%" },
            { icon: "🍑", name: "복숭아 ×3", chance: "15%" },
            { icon: "🍑", name: "복숭아 ×5", chance: "10%" },
            { icon: "🍓", name: "딸기 ×1", chance: "4.6%" },
            { icon: "shine", name: "샤인머스켓 ×1", chance: "0.39%" },
            { icon: "🍎", name: "사과 ×1", chance: "0.009%" },
    ...
    2: {
        ...
        exp: "150",
        drops: [
            { icon: "🍑", name: "복숭아 ×1", chance: "50%" },
            { icon: "🍑", name: "복숭아 ×3", chance: "30%" },
            { icon: "🍑", name: "복숭아 ×5", chance: "14%" },
            { icon: "🍓", name: "딸기 ×1", chance: "5.5%" },
            { icon: "shine", name: "샤인머스켓 ×1", chance: "0.48%" },
            { icon: "🍎", name: "사과 ×1", chance: "0.015%" },
...
const levelTitle = document.querySelector(".farm-level-title");

function getIcon(icon) {

    if (icon === "shine") {
        return '<img src="../../images/shine.png" alt="샤인머스켓">';
    }

    if (icon === "sansam") {
        return '<img src="../../images/sansam.png" alt="산삼">';
    }
...
function loadLevel(level) {
    ...
    expValue.textContent = `${data.exp} EXP`;
